#if !defined(__TRAVERSEWEAKVALUE_H__)
#define __TRAVERSEWEAKVALUE_H__
...
#ifndef _GCVALUEN_
	#define gcvalueN (iscollectable(o) ? gcvalue(o) : NULL)
#endif
...
typedef struct __traverseweakvalue
{
/* 接口函数 */
	Fun			fun;
/* 输入端口 */
