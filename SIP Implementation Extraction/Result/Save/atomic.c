...
void atomicFun(void *p) 
{
  ...
  {IPCALL(propagateall,ippropagateall_3,.g = g);}  /* propagate changes */
  g->gray = grayagain;
  ...
  {IPCALL(clearbyvalues,ipclearbyvalues_2,.g = g,.l = g->weak,.f = NULL);}
  {IPCALL(clearbyvalues,ipclearbyvalues_0,.g = g,.l = g->allweak,.f = NULL);}
  ...
  {IPCALL(propagateall,ippropagateall_2,.g = g);}  /* remark, to propagate 'resurrection' */
  ...
  {IPCALL(clearbyvalues,ipclearbyvalues_3,.g = g,.l = g->allweak,.f = origall);}
