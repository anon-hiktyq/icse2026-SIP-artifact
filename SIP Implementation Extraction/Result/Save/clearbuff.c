...
void clearbuffFun(void *p) 
{
  ...
  const char *res;
  {TStatus luaD_rawrunprotected_ret_0;IPCALL(luaD_rawrunprotected,ipluaD_rawrunprotected_0,.ret = &luaD_rawrunprotected_ret_0);if (luaD_rawrunprotected_ret_0 != LUA_OK)  /* errors? */
