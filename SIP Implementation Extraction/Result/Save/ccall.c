...
void ccallFun(void *p) 
{
  ...
  {CallInfo * luaD_precall_ret_0;IPCALL(luaD_precall,ipluaD_precall_0,.L = pIp->L,.func = pIp->func,.nresults = pIp->nResults,.ret = luaD_precall_ret_0);if ((ci = luaD_precall_ret_0) != NULL) {  /* Lua function? */
