...
void luaE_warnerrorFun(void *p) 
{
  ...
  {IPCALL(luaE_warning,ipluaE_warning_0,.L = pIp->L,.msg = "error in ",.tocont = 1);}
  {IPCALL(luaE_warning,ipluaE_warning_2,.L = pIp->L,.msg = pIp->where,.tocont = 1);}
  {IPCALL(luaE_warning,ipluaE_warning_1,.L = pIp->L,.msg = " (",.tocont = 1);}
