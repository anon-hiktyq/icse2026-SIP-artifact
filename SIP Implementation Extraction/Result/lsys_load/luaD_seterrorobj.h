#if !defined(__LUAD_SETERROROBJ_H__)
...
#ifndef _luaS_newliteral_
#define _luaS_newliteral_
	#define luaS_newliteral (luaS_newlstr(L, "" s, \
	                                 (sizeof(s)/sizeof(char))-1))
#endif

#ifndef _errorstatus_
#define _errorstatus_
	#define errorstatus ((s) > LUA_YIELD)
#endif
