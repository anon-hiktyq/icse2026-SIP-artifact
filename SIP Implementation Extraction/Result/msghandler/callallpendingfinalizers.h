#if !defined(__CALLALLPENDINGFINALIZERS_H__)
#define __CALLALLPENDINGFINALIZERS_H__
...
typedef struct __callallpendingfinalizers
{
...
#endif // __CALLALLPENDINGFINALIZERS_H__