...
void atomicFun(void *p) 
{
  ...
  {IPCALL(propagateall,ippropagateall_2,.g = g);}  /* empties 'gray' list */
  /* remark occasional upvalues of (maybe) dead threads */
  {IPCALL(remarkupvals,ipremarkupvals_0,.g = g);}
  {IPCALL(propagateall,ippropagateall_1,.g = g);}  /* propagate changes */
  g->gray = grayagain;
  ...
  {IPCALL(clearbyvalues,ipclearbyvalues_1,.g = g,.l = g->weak,.f = NULL);}
  ...
  {IPCALL(clearbyvalues,ipclearbyvalues_2,.g = g,.l = g->weak,.f = origweak);}
