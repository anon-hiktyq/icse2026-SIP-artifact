#if !defined(__LUAC_CHECKFINALIZER_H__)
#define __LUAC_CHECKFINALIZER_H__
...
#ifndef _l_setbit_
#define _l_setbit_
	#define l_setbit setbits(x, bitmask(b))
#endif
...
typedef struct __luaC_checkfinalizer
{
...
#endif // __LUAC_CHECKFINALIZER_H__