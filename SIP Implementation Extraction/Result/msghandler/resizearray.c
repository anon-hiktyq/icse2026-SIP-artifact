...
void resizearrayFun(void *p) 
{
  ...
  if ((pIp->oldasize) == (pIp->newasize))
    ...
    size_t newasizeb;{size_t concretesize_ret_2; IPCALL(concretesize,ipconcretesize_2,.size = pIp->newasize,.ret = &concretesize_ret_2);newasizeb = concretesize_ret_2;}
    ...
    if ((pIp->oldasize) > 0) {
      ...
      size_t oldasizeb;{size_t concretesize_ret_1; IPCALL(concretesize,ipconcretesize_1,.size = pIp->oldasize,.ret = &concretesize_ret_1);oldasizeb = concretesize_ret_1;}
