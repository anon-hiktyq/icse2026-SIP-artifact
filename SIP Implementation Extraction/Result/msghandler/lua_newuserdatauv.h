#if !defined(__LUA_NEWUSERDATAUV_H__)
#define __LUA_NEWUSERDATAUV_H__
...
#ifndef _setuvalue_
#define _setuvalue_
	#define setuvalue { TValue *io = (obj); Udata *x_ = (x); \
...
typedef struct __lua_newuserdatauv
{
