...
class CharDistributionAnalysis:
    ...
    def get_confidence(self) -> float:
        ...
        # if we didn't receive any character in our consideration content_range,
...
class EUCTWDistributionAnalysis(CharDistributionAnalysis):
    ...
    def get_order(self, byte_str: Union[bytes, bytearray]) -> int:
        ...
        #   first  byte content_range: 0xc4 -- 0xfe
        #   second byte content_range: 0xa1 -- 0xfe
...
class EUCKRDistributionAnalysis(CharDistributionAnalysis):
    ...
    def get_order(self, byte_str: Union[bytes, bytearray]) -> int:
        ...
        #   first  byte content_range: 0xb0 -- 0xfe
        #   second byte content_range: 0xa1 -- 0xfe
        # no validation needed here. State machine has done that
        first_char = byte_str[0]
        if first_char >= 0xB0:
...
class Big5DistributionAnalysis(CharDistributionAnalysis):
    ...
    def get_order(self, byte_str: Union[bytes, bytearray]) -> int:
        ...
        #   first  byte content_range: 0xa4 -- 0xfe
        #   second byte content_range: 0x40 -- 0x7e , 0xa1 -- 0xfe
        # no validation needed here. State machine has done that
        first_char, second_char = byte_str[0], byte_str[1]
        if first_char >= 0xA4:
            if second_char >= 0xA1:
...
class SJISDistributionAnalysis(CharDistributionAnalysis):
    ...
    def get_order(self, byte_str: Union[bytes, bytearray]) -> int:
        ...
        #   first  byte content_range: 0x81 -- 0x9f , 0xe0 -- 0xfe
        #   second byte content_range: 0x40 -- 0x7e,  0x81 -- oxfe
        # no validation needed here. State machine has done that
        first_char, second_char = byte_str[0], byte_str[1]
...
class EUCJPDistributionAnalysis(CharDistributionAnalysis):
    ...
    def get_order(self, byte_str: Union[bytes, bytearray]) -> int:
        ...
        #   first  byte content_range: 0xa0 -- 0xfe
        #   second byte content_range: 0xa1 -- 0xfe
        # no validation needed here. State machine has done that
        char = byte_str[0]
        if char >= 0xA0:
