    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'print', 'property', 'content_range', 'repr', 'reversed', 'round', 'set',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'oct', 'open', 'ord', 'pow', 'property', 'content_range', 'raw_input', 'reduce',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'content_range', 'raw_input', 'reduce', 'reload', 'repr', 'reversed',
    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                'property', 'content_range', 'set', 'set\'', 'slice', 'staticmethod', 'str',
...
class NumPyLexer(PythonLexer):
    ...
    EXTRA_KEYWORDS = {
        ...
        'issubdtype', 'issubsctype', 'callee', 'itemset', 'iterable', 'ix_',
