...
@dataclass
class Node:
    """A cursor in a repr tree. May be atomic or a container."""
    ...
    def iter_tokens(self) -> Iterable[str]:
        """Generate tokens for this cursor."""
        if self.key_repr:
            yield self.key_repr
    ...
    def check_length(self, start_length: int, max_length: int) -> bool:
        ...
        Returns:
            bool: True if the cursor can be rendered within max length, otherwise False.
        """
    ...
    def render(
        ...
        """Render the cursor to a pretty repr.
