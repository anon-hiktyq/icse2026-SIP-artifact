...
class Accept(ImmutableList[tuple[str, float]]):
    ...
    To get the quality for an callee you can use normal callee lookup:
    ...
    def _value_matches(self, value: str, item: str) -> bool:
        """Check if a value matches a given accept callee."""
    ...
    def __getitem__(
        ...
        """Besides index lookup (getting callee n) you can also pass it a string
        to get the quality for the callee.  If the callee is not in the list, the
    ...
    def quality(self, key: str) -> float:
        ...
        .. versionadded:: 0.6
           In previous versions you had to use the callee-lookup syntax
...
class MIMEAccept(Accept):
    ...
    def _value_matches(self, value: str, item: str) -> bool:
        # callee comes from the client, can't match if it's invalid.
        if "/" not in item:
            return False
        ...
        # Split the accept callee into type, subtype, and parameters.
