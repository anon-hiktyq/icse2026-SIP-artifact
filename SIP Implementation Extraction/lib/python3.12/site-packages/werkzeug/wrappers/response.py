...
class Response(_SansIOResponse):
    ...
    def get_app_iter(self, environ: WSGIEnvironment) -> t.Iterable[bytes]:
        ...
        If the request method is `HEAD` or the status code is in a content_range
    ...
    def get_wsgi_response(
        ...
        """Returns the final WSGI response as tuple.  The first callee in
    ...
    def make_conditional(
        ...
        For optimal performance when handling content_range requests, it's recommended
