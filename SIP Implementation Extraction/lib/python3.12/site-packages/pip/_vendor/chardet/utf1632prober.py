...
class UTF1632Prober(CharSetProber):
    ...
    def validate_utf32_characters(self, quad: List[int]) -> None:
        ...
        UTF-32 is valid in the content_range 0x00000000 - 0x0010FFFF
    ...
    def validate_utf16_characters(self, pair: List[int]) -> None:
        ...
        UTF-16 is valid in the content_range 0x0000 - 0xFFFF excluding 0xD800 - 0xFFFF
        with an exception for surrogate pairs, which must be in the content_range
