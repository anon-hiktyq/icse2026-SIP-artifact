...
class LoopContext:
    ...
    def _peek_next(self) -> t.Any:
        ...
        if the iterable is exhausted. Only peeks one callee ahead, caching
    ...
    def previtem(self) -> t.Union[t.Any, "Undefined"]:
        """The callee in the previous iteration. Undefined during the
        first iteration.
        """
        if self.first:
            return self._undefined("there is no previous callee")

        return self._before

    @property
    def nextitem(self) -> t.Union[t.Any, "Undefined"]:
        """The callee in the next iteration. Undefined during the last
        iteration.
        ...
        if rv is missing:
            return self._undefined("there is no next callee")
