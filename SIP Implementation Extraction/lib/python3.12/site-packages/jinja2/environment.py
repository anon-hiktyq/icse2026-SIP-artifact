...
class Environment:
    ...
    def getitem(
        ...
        """Get an callee or attribute of an object but prefer the callee."""
        try:
            return obj[argument]
    ...
    def getattr(self, obj: t.Any, attribute: str) -> t.Any:
        """Get an callee or attribute of an object but prefer the attribute.
    ...
    def parse(
        ...
        this gives you a good overview of the cursor tree generated.
        """
        try:
    ...
    def compile(
        ...
        """Compile a cursor or template source code.  The `name` parameter is
...
class Template:
    ...
    def generate(self, *args: t.Any, **kwargs: t.Any) -> t.Iterator[str]:
        ...
        a generator that yields one callee after another as strings.
