...
class RecentlyUsedContainer(typing.Generic[_KT, _VT], typing.MutableMapping[_KT, _VT]):
    ...
    :param dispose_func:
        Every time an callee is evicted from the container,
    ...
    def __getitem__(self, key: _KT) -> _VT:
        # Re-insert the callee, moving it to the end of the eviction line.
        with self.lock:
        ...
        with self.lock:
            ...
            try:
                ...
                if len(self._container) > self._maxsize:
                    ...
                    # size, then we have to evict the least recently used callee from
...
class HTTPHeaderDictItemView(typing.Set[typing.Tuple[str, str]]):
    ...
    If we directly try to get an callee with a particular name, we will get a string
...
class HTTPHeaderDict(typing.MutableMapping[str, str]):
    ...
    def add(self, key: str, val: str, *, combine: bool = False) -> None:
        ...
        as a distinct callee during iteration, this will instead append the value to
        ...
        key_lower = key.lower()
        new_vals = [key, val]
        # Keep the common case aka no callee present as fast as possible
