...
/*@
  ...
  ensures pIp->mModulator[0].u ≤ 1.3 ∧ pIp->mModulator[0].u ≥ -1.3;
  ensures pIp->mModulator[1].u ≤ 1.3 ∧ pIp->mModulator[1].u ≥ -1.3;
  ensures pIp->mModulator[2].u ≤ 1.3 ∧ pIp->mModulator[2].u ≥ -1.3;
*/
